...
export const NavBar = () => {
    ...
    return (
        <Disclosure
            as="nav"
            className="relative nav-color after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10"
        >
                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex shrink-0 items-center">
                            <img
                                alt="Univendas logo"
                                src="/imagens/Logos/univendas.png"
